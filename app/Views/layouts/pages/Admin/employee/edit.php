                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input name="nik"
                                ...
                                placeholder="example: 3521067738749" value="<?= $user['nik'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input name="age"
                                class="form-control <?= ($validation->hasError('age') ? 'is-invalid' : '') ?>" id="age"
                                placeholder="example: 20" value="<?= $user['age'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input name="phone_number"
                                ...
                                id="phone" placeholder="example: 08146635529" value="<?= $user['phone_number'] ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input name="fullname"
                                ...
                                id="fullname" placeholder="example: brotherhood" value="<?= $user['fullname'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input name="position"
                                ...
                                id="position" value="<?= old('position') ?>" placeholder="example: Programmer">
                            <div class="invalid-feedback">
