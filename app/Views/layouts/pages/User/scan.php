...
<div style="display: flex; justify-content: center; position: relative; text-align: center">
    ...
    <h5 class="text-center" style="position: absolute; font-size: 12px; color: #fff; z-index: 1; width: 100%; margin-top: 31em;">Please QR Code inside this square</h5>
    <video id="preview" width="100%" style="z-index: 0"></video>
</div>
