...
<div class="container-fluid">
  <div class="d-sm-flex flex-column mb-4">
    <h1 class="h3 mb-3 text-gray-800">Gallery</h1>
  </div>
  ...
  <?php foreach ($galleries as $gallery) : ?>
    <div class="modal fade" id="deleteModal<?= $gallery['galleries_id'] ?>" data-bs-backdrop="static" tabindex="-1">
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="pt-3">
              ...
              <form class="d-inline" method="post" action="<?= base_url(); ?>/gallery/delete/<?= $gallery['galleries_id'] ?>">
                <?= csrf_field() ?>
