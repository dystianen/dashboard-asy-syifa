...
<body>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between flex-column align-items-center">
                        <div class="logo">
                            <a><span style="font-size: 26px">Asy-Syifa'</span></a>
                        </div>
        ...
        <div id="main">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-end">
                        <p style="margin-right: 15px">Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a>Artisan</a></p>
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs5/jq-3.6.0/jszip-2.5.0/dt-1.11.5/b-2.2.2/b-colvis-2.2.2/b-html5-2.2.2/b-print-2.2.2/fc-4.0.2/r-2.2.9/sb-1.3.2/sp-2.0.0/datatables.min.js">
    </script>
